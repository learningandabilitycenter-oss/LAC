...
export interface Post {
  ...
  title: string;
  /**
   * Use lowercase words separated by hyphens, for example: supporting-child-confidence
   */
  slug: string;
  excerpt: string;
  category: 'mental-health' | 'parent-guidance' | 'learning-support' | 'foundation-stories';
...
export interface Announcement {
  ...
  title: string;
  summary: string;
  type: 'notice' | 'camp' | 'event' | 'membership';
...
export interface Update {
  ...
  slug: string;
  summary: string;
  type: 'community' | 'clinical' | 'awareness' | 'foundation';
