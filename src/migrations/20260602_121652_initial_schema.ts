...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_posts_category" AS ENUM('mental-health', 'parent-guidance', 'learning-support', 'foundation-stories');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_category" AS ENUM('mental-health', 'parent-guidance', 'learning-support', 'foundation-stories');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_announcements_type" AS ENUM('notice', 'camp', 'event', 'membership');
  CREATE TYPE "public"."enum_updates_type" AS ENUM('community', 'clinical', 'awareness', 'foundation');
  CREATE TYPE "public"."enum_gallery_items_media_type" AS ENUM('image', 'video');
  CREATE TYPE "public"."enum_enquiries_subject" AS ENUM('general', 'counselling', 'developmental', 'speech-therapy', 'learning-support', 'family-guidance', 'foundation');
  CREATE TYPE "public"."enum_enquiries_status" AS ENUM('new', 'responded', 'closed');
  ...
  CREATE TABLE "posts" (
  	...
  	"slug" varchar,
  	"excerpt" varchar,
  	"category" "enum_posts_category" DEFAULT 'mental-health',
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_category" "enum__posts_v_version_category" DEFAULT 'mental-health',
  ...
  CREATE TABLE "announcements" (
  	...
  	"type" "enum_announcements_type" DEFAULT 'notice' NOT NULL,
  	"link_label" varchar,
  	"link_url" varchar,
  ...
  CREATE TABLE "updates" (
  	...
  	"summary" varchar NOT NULL,
  	"type" "enum_updates_type" DEFAULT 'community' NOT NULL,
  	"image_id" integer,
  	"published_at" timestamp(3) with time zone NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  ...
  CREATE TABLE "gallery_items" (
  	...
  	"title" varchar NOT NULL,
  	"description" varchar,
  	"media_type" "enum_gallery_items_media_type" DEFAULT 'image' NOT NULL,
  	"image_id" integer,
  	"video_url" varchar,
  ...
  CREATE TABLE "enquiries" (
  	...
  	"email" varchar NOT NULL,
  	"phone" varchar,
  	"subject" "enum_enquiries_subject" DEFAULT 'general' NOT NULL,
